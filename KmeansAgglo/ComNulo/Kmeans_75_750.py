...
def CountFrequency(my_list,count,v): 
    ...
    df_ocorrencias_ordenadas.to_csv(r'/home/oscar/TesteJR/KmeansAgglo/ComNulo/RESULTADO_K_FOLD:'+str(contador)+ "   Grupo: "+str(v)+".csv")
...
#    print("Tempo inicio: "+ str(datetime.now().strftime('%Y-%m-%d %H:%M:%S')))
    ...
    df_silueta.to_csv(r'/home/oscar/TesteJR/KmeansAgglo/ComNulo/Shilhoutte_KFold_'+str(contador)+".csv")
