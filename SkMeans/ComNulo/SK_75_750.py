...
def CountFrequency(my_list,count,v): 
    ...
    df_ocorrencias_ordenadas.to_csv(r'/home/oscar/TesteJR/SkMeans/ComNulo/RESULTADO_K_FOLD:'+str(contador)+ "   Grupo: "+str(v)+".csv")
...
#    clusterer.fit(test_np[:,1:])
    ...
    df_silueta.to_csv(r'/home/oscar/TesteJR/SkMeans/ComNulo/Shilhoutte_KFold_'+str(contador)+".csv")
